...
def plot_air_traffic_density_matrix(
    ...
    if "latitude" not in flight_dataframe.columns or "longitude" not in flight_dataframe.columns:
        msg = "Flight data must contain 'latitude' and 'longitude' columns"
...
if __name__ == "__main__":
    ...
    plot_air_traffic_density_matrix(
        ...
        output_plot_name="air_traffic_density_map",
    )
